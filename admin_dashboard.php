<?php
require 'session.php';
check_role(['admin']); // Only admin allowed
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Admin Dashboard - Blend S</title>
    <style>
        body {
...
<body>
    ...
    <div class="container mt-4">
        <div class="card p-4">
            <h1 class="text-choco">Cashier Homepage</h1>
            <p class="lead text-choco">Use the navigation links to take new orders, add menu items, or view past sales.</p>
        </div>
    </div>
</body>
</html>
